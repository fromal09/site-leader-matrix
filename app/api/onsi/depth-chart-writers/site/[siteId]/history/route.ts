...
export async function GET(
  ...
  try {
    const siteDivisionRows = await sql`SELECT id, division FROM onsi_sites`;
    ...
    // Pre-current-year periods may have had their raw onsi_article_traffic
    ...
    const archiveRows = await sql`SELECT * FROM onsi_site_traffic_archive`;
