export const NFL_TEAM_COLORS: Record<string, { primary: string; secondary: string }> = {
  ...
  "Dallas Stars": { primary: "#006847", secondary: "#000000" },
  ...
  "General NHL": { primary: "#000000", secondary: "#C8102E" },
  "New Jersey Devils": { primary: "#CE1126", secondary: "#000000" },
  "Anaheim Ducks": { primary: "#F47A38", secondary: "#000000" },
  ...
  "Utah Mammoth": { primary: "#71AFE5", secondary: "#010101" },
